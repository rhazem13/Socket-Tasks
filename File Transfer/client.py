...
class ClientGUI:
    def __init__(self):
        ...
        self.select_file_button = tk.Button(self.root, text="Select File", command=self.select_file, bg="#3498db", fg="white", padx=20, pady=10, font=("Arial", 12))
        self.select_file_button.pack(pady=20)

        self.send_button = tk.Button(self.root, text="Send File", command=self.send_file, state=tk.DISABLED, bg="#2ecc71", fg="white", padx=20, pady=10, font=("Arial", 12))
        self.send_button.pack(pady=10)

        self.status_label = tk.Label(self.root, text="Not Connected", fg="white", bg="#2c3e50", font=("Arial", 14))
